package com.example.user.utils.loaddrawable.circle.jump;
...
public class CollisionLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        mBallRadius = AppUtils.dp2px(context, DEFAULT_BALL_RADIUS);
        mWidth =AppUtils.dp2px(context, DEFAULT_WIDTH);
        mHeight =AppUtils.dp2px(context, DEFAULT_HEIGHT);
        mOvalVerticalRadius =AppUtils.dp2px(context, DEFAULT_OVAL_HEIGHT);
