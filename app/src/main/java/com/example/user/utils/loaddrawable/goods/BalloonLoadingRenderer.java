package com.example.user.utils.loaddrawable.goods;
...
import com.example.user.utils.loaddrawable.LoadingRenderer;
import com.example.user.utils.util.AppUtils;
...
public class BalloonLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        mTextSize = AppUtils.dp2px(context, DEFAULT_TEXT_SIZE);

        mWidth = AppUtils.dp2px(context, DEFAULT_WIDTH);
        mHeight = AppUtils.dp2px(context, DEFAULT_HEIGHT);
        mStrokeWidth = AppUtils.dp2px(context, DEFAULT_STROKE_WIDTH);

        mGasTubeWidth = AppUtils.dp2px(context, DEFAULT_GAS_TUBE_WIDTH);
        mGasTubeHeight = AppUtils.dp2px(context, DEFAULT_GAS_TUBE_HEIGHT);
        mCannulaWidth = AppUtils.dp2px(context, DEFAULT_CANNULA_WIDTH);
        mCannulaHeight = AppUtils.dp2px(context, DEFAULT_CANNULA_HEIGHT);
        mCannulaOffsetY = AppUtils.dp2px(context, DEFAULT_CANNULA_OFFSET_Y);
        mCannulaMaxOffsetY = AppUtils.dp2px(context, DEFAULT_CANNULA_MAX_OFFSET_Y);
        mPipeBodyWidth = AppUtils.dp2px(context, DEFAULT_PIPE_BODY_WIDTH);
        mPipeBodyHeight = AppUtils.dp2px(context, DEFAULT_PIPE_BODY_HEIGHT);
        mBalloonWidth = AppUtils.dp2px(context, DEFAULT_BALLOON_WIDTH);
        mBalloonHeight = AppUtils.dp2px(context, DEFAULT_BALLOON_HEIGHT);
        mRectCornerRadius = AppUtils.dp2px(context, DEFAULT_RECT_CORNER_RADIUS);
