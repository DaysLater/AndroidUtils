...
public class WaterBottleLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mBottleWidth = AppUtils.dp2px(context, DEFAULT_BOTTLE_WIDTH);
        mBottleHeight = AppUtils.dp2px(context, DEFAULT_BOTTLE_HEIGHT);
        mWaterLowestPointToBottleneckDistance = AppUtils.dp2px(context, WATER_LOWEST_POINT_TO_BOTTLENECK_DISTANCE);
