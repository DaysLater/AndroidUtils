...
public class MapUtils {
     ...
     * @param lng     到达的维度
     */
    public static void openGDMap(Context context, String lat, String lng, String toAddress,final String appName) {
...
//            mapIntent.setPackage("com.google.android.apps.maps");
     ...
     * @param lng     目的地维度
     */
    public static void openBaiduMap(Context context, String lat, String lng, String toAddress,final String appName) {
     ...
     */
    public static void openTencentMap(Context context, String fromlat, String fromlng, String toAddress,final String appName) {
        Intent intent;
     ...
     */
    public static void openTencentMap(Context context, String fromAddress, String fromlat, String fromlng, String tolat, String tolng, String toAddress,final String appName) {
