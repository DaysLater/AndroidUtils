...
public class iQiYiLoadingView extends View {
    ...
    public iQiYiLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.iQiYiLoadingView);
        mOuterCircleRadius = typedArray.getDimensionPixelSize(R.styleable.iQiYiLoadingView_outerCircleRadius, 50);
        mOuterCircleColor = typedArray.getColor(R.styleable.iQiYiLoadingView_outerCircleColor, 0xFF228B22);
        mInnerTriangleRadius = typedArray.getDimensionPixelSize(R.styleable.iQiYiLoadingView_innerTriangleRadius, 25);
        mInnerTriangleColor = typedArray.getColor(R.styleable.iQiYiLoadingView_innerTriangleColor, 0xFF228B22);
        mIsNeedBackground = typedArray.getBoolean(R.styleable.iQiYiLoadingView_isNeedBackground, true);
        mBackgroundColor = typedArray.getColor(R.styleable.iQiYiLoadingView_backgroundColor, 0xBB222222);
        mStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.iQiYiLoadingView_strokeWidth, 5);
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<iQiYiLoadingView> mLoadingViewWeakReference;

        public MyHandler(iQiYiLoadingView loadingView) {
            mLoadingViewWeakReference = new WeakReference<iQiYiLoadingView>(loadingView);
        }
